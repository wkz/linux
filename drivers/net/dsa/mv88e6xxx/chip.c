...
static int mv88e6xxx_setup_port(struct mv88e6xxx_chip *chip, int port)
{
	...
	/* On chips that supports it, set all DSA ports' VLAN policy to
	 * TRAP. In combination with loading MV88E6XXX_VID_STANDALONE as
	 * a policy entry in the VTU, this provides a better isolation
