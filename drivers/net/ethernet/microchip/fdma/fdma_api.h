 ...
 *
 * In some setups, it is required that the data pointers point to contiguous
 * DMA memory, in this case, a number of helper functions appended with
 * _contiguous can be used.
 */
...
#define FDMA_DB_MAX			15 /* Maximum number of DB's on Sparx5 */
